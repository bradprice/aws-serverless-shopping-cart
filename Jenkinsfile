pipeline {
  ...
  environment {
    ...
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'serverless-shopping-cart'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::078525157916:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-1CY3KYHN9FSW8'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::078525157916:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-NVBXK7RIEAMS'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-e7l4cmn4av1r'
    // If there are functions with "Image" PackageType in your template,
    // uncomment the line below and add "--image-repository ${TESTING_IMAGE_REPOSITORY}" to
    // testing "sam package" and "sam deploy" commands.
    // TESTING_IMAGE_REPOSITORY = '0123456789.dkr.ecr.region.amazonaws.com/repository-name'
    TESTING_REGION = 'us-east-1'
    PROD_STACK_NAME = 'serverless-shopping-cart'
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::078525157916:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-5K1U7X0OR5M9'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::078525157916:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-3RHPPTXDNODA'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-1a2fivj88kxew'
    // If there are functions with "Image" PackageType in your template,
